    ...
    return (
        ...
        {entries.map((entry: Entry, index: number) => {
            ...
            <div
                id={entry.id}
                key={index}
                className="bg-gray-300 dark:bg-gray-800 text-black dark:text-white shadow-md dark:shadow-gray-900 m-3 p-4 rounded flex flex-col justify-between"
            >
                ...
                <div className="flex justify-center">
                    ...
                    className="m-1 md:m-2 p-1 font-semibold rounded-md bg-red-500 dark:bg-red-700 hover:bg-red-700 dark:hover:bg-red-900"
                    >
                    ✖
                    </button>
                    <button
                    ...
                    className="m-1 md:m-2 p-1 font-semibold rounded-md bg-blue-500 dark:bg-blue-700 hover:bg-blue-700 dark:hover:bg-blue-900"
                    >
                    🖊
                    </button>
                </div>
